...
<body class="w-full h-full bg-gray-100">
    ...
    @if (session()->has('message'))
        <div class="w-4/5 mx-auto pb-10">
            <div class=" text-white bg-red-500 font-bold rounded-t px-4 py-2">
                Warning
            </div>
    ...
    @foreach($posts as $post)
        <div class="w-4/5 mx-auto pb-10">
            <div class="bg-white pt-10 rounded-lg drop-shadow-2xl sm:basis-3/4 basis-full pb-10 sm:pb-0">
                <div class="w-11/12 mx-auto pb-10">
                    ...
                    <form action="{{ route('blog.destroy', $post->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="pt-3 text-red-500 pr-3">
                            Delete
                        </button>
                    </form>
